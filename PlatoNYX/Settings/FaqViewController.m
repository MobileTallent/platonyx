...
- (void)initData {
    ...
    faqArray = [@[
         ...
         [@{@"question" : @"PlatoNYX ücretli mi?", @"answer" : @"İlk versiyonumuz itibariyle uygulama tamamen ücretsizdir. Ancak ilerleyen aşamalarda uygulamamızın ücretli olmasını öngörmekteyiz."} mutableCopy],
         ...
         [@{@"question" : @"Uygulamada bazı hatalar var. Neden?", @"answer" : @"Evet farkındayız ve uygulamamızın henüz ilk versiyonu olduğundan, bu konuda hoşgörünüze sığınıyoruz. Ancak gördüğünüz hataları bize İletişim bölümünden aktarırsanız, hızlıl bir şekilde çözmek için elimizden geleni yaparız."} mutableCopy],
